...
program ice
  ...
  integer :: out_step(10), expnb, expres, ts_res, fgmres_its, fgmres_per_ts
  integer :: time_out, n_output
...
!------------------------------------------------------------------------
  ...
  constant_wind  = .false. ! T: 10m/s, F: spat and temp varying winds
  rampupwind     = .true.
