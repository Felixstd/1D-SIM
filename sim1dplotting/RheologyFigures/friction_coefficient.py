...
ax.set_yticklabels([r'$\mu_0$', r'$\mu_\infty$'], fontsize = 15)

ax.text(0.02, 1.05, 'Quasi-Static', transform=ax.transAxes, fontsize=15,
        verticalalignment='top')

# ax.text(0.02, 0.55, 'Pack Ice', transform=ax.transAxes, fontsize=15,
        # verticalalignment='top')
...
# ax.text(0.8, 0.55, 'Marginal\nIce\nZone', transform=ax.transAxes, fontsize=15,
#         verticalalignment='top', ha='left',va='center')
