...
program ice
    ...
    double precision, allocatable :: P_fric_R_Tavg(:)
    double precision, allocatable :: P_fric_S_Tavg(:)
...
!------------------------------------------------------------------------   
        if (mechenergy) then 
            ...
            call average_mech_energy(P_pot_avg, P_fric_R_avg, P_fric_S_avg, P_lat_avg, P_h_avg, P_w_avg)
...
!     call check_neg_vel(u)
    ...
    call output_mech_energy(P_pot_Tavg, P_fric_R_Tavg, P_fric_S_Tavg, P_lat_Tavg, P_h_Tavg, P_w_Tavg, ts, expnb, solver, nstep)
